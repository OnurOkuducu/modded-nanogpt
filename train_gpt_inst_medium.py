...
class GPT(nn.Module):
    ...
    def forward(self, input_seq: Tensor, target_seq: Tensor, sliding_window_num_blocks: Tensor):
        ...
        ignore_mask = build_ignore_mask_stream(target_seq)  # bool, True => ignore
        labels = target_seq.clone()
        labels[ignore_mask] = -100  # PyTorch ignore_index
...
class Hyperparameters:
    ...
    # implementation
    seq_len = 24*1024 # FlexAttention sequence length
